                        ...
                        <div class="food">
                            ...
                            <form action="admin_modify_food.php" method="post" enctype="multipart/form-data">
								<figure class="food_area">
									...
									<input id="file_modify<?php echo $value['food_id']?>" class="file_modify" style="display:none" type="file" name="file_modify" accept="image/png, image/jpeg, image/gif, image/jpg"/>
									<label for="file_modify<?php echo $value['food_id']?>" class="change_pic">click to change pic</label>
									<figcaption>
